...
|---|---|---|
| 🎮 [**Mini-Jogo Concorrente**](https://github.com/hugogomes111/PC25-26_grupo17) | Real-time multiplayer arena game with a concurrent Erlang server | Erlang · Java · Processing |
| ⚙️ [**Runner & Controller**](https://github.com/hugogomes111/porject_SO_25-26) | A command scheduler built on raw Unix processes, pipes, and syscalls | C · POSIX |
| 🧩 [**Pascal → VM Compiler**](https://github.com/hugogomes111/project_plc) | A compiler for a Pascal-like language targeting a stack-based VM | Python · PLY |
| 🏅 [**FDM Database**](https://github.com/hugogomes111/data_base) | Relational database for managing athletes, teams, and competitions | MySQL · SQL |
| 🎵 [**SpotifUM**](https://github.com/hugogomes111/object-oriented_programming) | Spotify-inspired platform built around OOP design principles | Java · MVC |

### 📊 GitHub Stats

<div align="center">

<img src="https://github-readme-stats.vercel.app/api?username=hugogomes111&show_icons=true&theme=default&hide_border=true" alt="GitHub Stats" height="165">
<img src="https://github-readme-streak-stats.herokuapp.com/?user=hugogomes111&hide_border=true" alt="GitHub Streak" height="165">
